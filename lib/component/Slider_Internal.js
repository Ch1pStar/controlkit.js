...
Slider_Internal.prototype._update = function(){
    var mx = Mouse.get().getX(),
        sx = this._slot.offsetX + (this._slot.node._element.getBoundingClientRect().left - this._slot.offsetX),
        sw = Math.floor(this._slot.node._element.offsetWidth - this._slot.padding*2),
...
Slider_Internal.prototype._updateHandle = function(){
    var slotWidth   = Math.floor(this._slot.node._element.offsetWidth - this._slot.padding*2),
